...
def test_create_variant_exclude(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/create_variant_exclude/config")
        data_path = Path(".tests/unit/create_variant_exclude/data")
        expected_path = Path(".tests/unit/create_variant_exclude/expected")
