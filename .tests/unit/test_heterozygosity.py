...
def test_heterozygosity(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/heterozygosity/config")
        data_path = Path(".tests/unit/heterozygosity/data")
        expected_path = Path(".tests/unit/heterozygosity/expected")
