...
def test_get_var_data(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/get_var_data/config")
        data_path = Path(".tests/unit/get_var_data/data")
        expected_path = Path(".tests/unit/get_var_data/expected")
